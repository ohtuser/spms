        ...
        <div class="insert_drawer" onclick="dontHideAddNewDrawer(event)">
            <div class="row d-flex justify-content-center">
                <div class="col-11">
                    ...
                    <form action="{{ route('student.store') }}" class="form_submit">
                        ...
                        <div class="form-group">
                            ...
                            <select name="batch_id" id="batch_form" class="form-control select_2">
...
@section('script')
    <script>
        ...
        let ajaxUrl = "{{ route('student.index') }}";
        let ajaxData = {};
        ...
        function edit(id){
            ...
            customAjaxCall(function(res){
                ...
                $('#batch_form').val(res.info.batch_id).trigger('change');
                $('#mobile_form').val(res.info.mobile);
                closeSweetAlert();
            }, 'get', "{{ route('student.edit') }}", {id});
        }
    </script>
